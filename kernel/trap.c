...
void usertrap(void)
{
  ...
  else if (r_scause() == 15)
  {
    ...
    uvmcopy(p->pagetable, p->pagetable , PGSIZE, 1, start_va);
    // pte_t *pte;
  ...
  // {
  //   // Environment Call (ECALL) trap

  //   // Retrieve the system call number from the appropriate register. In xv6, the system call number is passed in register a7
  //   // int syscall_num = r_a7();
  // }
